      ...
      <div className="p-5 sm:p-6">
        <div className="flex items-start justify-between gap-3 mb-4">
          <div className="flex items-center gap-3">
            ...
            <div
              className={`w-12 h-12 rounded-xl bg-gradient-to-br from-indigo-500 to-indigo-700 text-white font-bold flex items-center justify-center text-lg shadow-inner ${
        ...
        {nextEvent ? (
          <div className="bg-slate-50/80 rounded-xl p-3.5 border border-slate-200/60 mb-2">
          ...
          <div className="bg-slate-50 rounded-xl p-3 text-center border border-dashed border-slate-200 mb-2">
            <p className="text-xs text-slate-500">No active upcoming activities scheduled.</p>
          </div>
        )}
      </div>

      <div className="px-5 sm:px-6 py-3.5 bg-slate-50/60 border-t border-slate-100 flex items-center gap-2">
        {nextEvent && (nextEvent.url || company.registrationUrl) ? (
          <a
            href={nextEvent.url || company.registrationUrl}
            target="_blank"
            rel="noopener noreferrer"
            className="flex-1 inline-flex items-center justify-center gap-1.5 px-3 py-2 bg-indigo-600 text-white rounded-xl text-xs font-semibold hover:bg-indigo-500 active:bg-indigo-700 transition-colors shadow-2xs"
          >
        ...
        <Link
          ...
          className="flex-1 inline-flex items-center justify-center gap-1.5 px-3 py-2 bg-white text-slate-700 border border-slate-200 rounded-xl text-xs font-semibold hover:bg-slate-50 hover:text-slate-900 transition-colors"
        >
